...
my_color <- 'd3.scaleOrdinal() .domain(["invisible", "matches", "pseudomatches", "tool1", "tool2", "tool3", "tool4A", "tool4B", "tool4C", "tool4D", "tool4E", "tool4F", "tool5"]) .range(["white", "blue", "orange", "green", "purple", "red", "yellow", "orange", "yellow", "orange", "yellow", "orange", "black"])'
