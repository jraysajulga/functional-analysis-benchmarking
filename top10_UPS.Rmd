...
nodes=data.frame(
    source=c(as.character(functool1), as.character(functool2), as.character(functool3), as.character(functool4)),
    target=c(as.character(functool2), as.character(functool3), as.character(functool4), as.character(functool5)),
...
links <- rbind(nodes, data.frame(
    ...
    group = as.factor(rep("pseudomatches", nrow(pseudoMatches))),
    value = rep(0.1, length(pseudoMatches))
))
