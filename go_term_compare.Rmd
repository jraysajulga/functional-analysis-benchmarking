...
nrow(metagomics %>% filter(Laplace.corr..q.value < 0.05)) #significant at FDR < 5%
```
...
for i in ['eggnog', 'megan', 'metagomics', 'unipept', 'mpa', 'prophane']:
...
```{r}
methods <- c("megan", "metagomics", "unipept", "eggnog", 'mpa', 'prophane')
