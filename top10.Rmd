...
library(knitr)
kable(head(eggnog_w_counts, 10), caption = "eggNOG-mapper: top 10 fold changes")
```
...
Print results:
```{r echo=FALSE, results='asis'}
kable(head(blast_counts, 10), caption = "BLAST: Top 10 fold changes")
```
...
Top 10 results:
```{r echo=FALSE, results='asis'}
kable(head(metagomics_filt, 10), caption = "MetaGOmics: Top 10 fold changes")
```
...
Top 10 results:
```{r echo=FALSE, results='asis'}
kable(head(megan, 10), caption = "MEGAN: Top 10 fold changes")
```
...
Top 10:
```{r echo=FALSE, results='asis'}
kable(head(unipept_all, 10), caption = "Unipept: top 10 Fold Changes")
```
...
Top 10:
```{r echo=FALSE, results='asis'}
kable(head(pAll, 10), caption = "MetaProteomeAnalyzer: top 10 Fold Changes")
```
