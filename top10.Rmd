...
tool1 <- getMatches(unipept_topn, eggnog_w_counts$name, "EggNOG")
tool2 <- getMatches(unipept_topn, megan$name, "MEGAN")
tool3 <- getMatches(unipept_topn, metagomics_filt$name, "MetaGOmics")
tool4 <- getMatches(unipept_topn, pAll$name, "MPA")
tool5 <- getMatches(unipept_topn, prophane$names, "Prophane")
...
my_color <- 'd3.scaleOrdinal() .domain(["invisible", "tool1", "tool2", "tool3", "tool4", "tool5"]) .range(["white", "blue", "orange", "green", "purple", "red", "yellow", "black"])'
