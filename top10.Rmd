...
print_mqome_cmds <- function(name, func_colname){
  cmd_expand <- paste0("metaquantome expand --mode f --data_dir data/databases/gene_ontology/mqome",
                       ...
                       " --samps results/mqome/input/", name, "/", name, "_samples.tab",
  ...
  cmd_filt <- paste0("metaquantome filter",
                     ...
                     " --mode f --ontology go",
                     " --samps results/mqome/input/", name, "/", name, "_samples.tab",
                     " --min_peptides 1 --min_pep_nsamp 1 --min_children_non_leaf 1 --min_child_nsamp 1",
                     " --qthreshold 1 --outfile results/mqome/output/", name, "/", name, "_func_filtered.tab")
  print(cmd_expand)
  print(cmd_filt)
}
print_mqome_cmds("eggnog", 'gos')
```
```{r}
