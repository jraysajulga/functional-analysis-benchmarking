...
```{r}
intersect_all_tools <- Reduce(intersect, sapply(tools_gos, function(tool) { tool[tool$namespace == "MF",]$gos }))
length(intersect_all_tools)
#test <- unipept_all[unipept_all$gos %in% intersect_all_tools,] #%>% arrange(gos)
#test
```
