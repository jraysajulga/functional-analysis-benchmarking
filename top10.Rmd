...
unipept_top_matches <- plyr::join_all(
    list(getMatches(unipept_topn, eggnog_w_counts$name[1:10], "EggNOG"),
         #getMatches(unipept_topn, megan$og)
         getMatches(unipept_topn, metagomics_filt$name[1:10], "MetaGOmics"),
         #getMatches(unipept_topn, pAll$Protein.Description)
         getMatches(unipept_topn, prophane$names[1:10], "Prophane")),
    by="name")
unipept_top_matches
```
