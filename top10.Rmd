...
```{r}
plot_correlation <- function(unipept, metagomics, header, dims, suffix=''){
  um <- inner_join(unipept, metagomics, by = header)
  png(paste0("results/correlation/um_cor", suffix, ".png"),
...
sapply(c("MF,CC,BP", "MF", "CC", "BP"),
       function(ontology){
         plot_correlation(unipept_all, metagomics, 'gos', c(-8, 8))
         plot_correlation(unipept_filtered, metagomics_filtered, 'id', c(-2.5, 2.5), suffix='-filtered')
       })
