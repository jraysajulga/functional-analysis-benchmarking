...
sankey_nodes_final$header <- c(tool_topn, 1:10)
...
nodes <- nodes %>% mutate(group = c(rep("block", 10),
                                    rep("invisible", 10),
                                    rep("top", 10),
                                    ifelse(gsub(" ", "", as.character(name[31:40])) == "", "invisible", labels[1]),
                                    rep("top", 10),
                                    ifelse(gsub(" ", "", as.character(name[51:60])) == "", "invisible", labels[2]),
                                    rep("top", 10),
                                    ifelse(gsub(" ", "", as.character(name[71:80])) == "", "invisible", labels[3]),
                                    rep("top", 10),
                                    ifelse(gsub(" ", "", as.character(name[91:100])) == "", "invisible", labels[4]),
                                    rep("top", 10),
                                    ifelse(gsub(" ", "", as.character(name[111:120])) == "", "invisible", labels[5])))
...
my_color <- paste('d3.scaleOrdinal() .domain(["invisible", "block", "top", "',
                  ...
                  tools$label[4], '", "',
                  tools$label[5], '", "',
                  tools$label[6], '"]) .range(["white", "black", "#ffe070", "red", "blue", "green", "orange", "purple", "pink"])', sep="")
