...
links=data.frame(
    source=c(as.character(functool1), as.character(functool2), as.character(functool3), as.character(functool4), as.character(matches$source[1])),
    target=c(as.character(functool2), as.character(functool3), as.character(functool4), as.character(functool5), as.character(matches$target[1])),
    value= c(values, .1))
# A3, D2, .5
...
my_color <- 'd3.scaleOrdinal() .domain(["type_a", "type_b", "a", "b"]) .range(["white", "green", "grey", "blue"])'
