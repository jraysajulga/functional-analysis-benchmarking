...
unipept_topn <- metagomics_gos[1:10]

tool1 <- getMatches(unipept_topn, eggnog_gos, tool1_label)
tool2 <- getMatches(unipept_topn, megan_gos, tool2_label)
tool3 <- getMatches(unipept_topn, mpa_gos, tool3_label)
tool4 <- getMatches(unipept_topn, prophane_gos, tool4_label)
tool5 <- getMatches(unipept_topn, unipept_gos, tool5_label)
