...
```
```{r}
#c(framework$source, unipept_nodes_final[, length(unipept_nodes_final)])
...
nodes <- nodes %>% mutate(group = ifelse(gsub(" ", "", name) == "", "invisible", "block"))
#nodes$group = as.factor(c(rep("topn", 10),
 #                         rep("labels", 100),
