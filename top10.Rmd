...
sapply(c("MF", "CC", "BP", "all"),
       function(ontology){
         plot_correlation(unipept_all, metagomics_filt, 'gos', c(-8, 8), ontology)
         plot_correlation(unipept_filtered, metagomics_filtered, 'id', c(-1.5, 1.5), ontology, suffix='-filtered')
       })
