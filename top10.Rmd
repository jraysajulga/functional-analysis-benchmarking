...
for (label in labels){
    ...
    # Add top ten terms and decile labels
    sankey_nodes_final <- cbind(data.frame(Term = c(tool_topn, paste(seq(0, 90, by=10), " - ", seq(10, 100, by=10), "%", sep=""))),
                                sankey_nodes_final)
    ...
    my_color <- paste('d3.scaleOrdinal() .domain(["invisible", "block", "header", "top", "',
                      ...
                      tools$label[4], '", "',
                      tools$label[5], '", "',
                      tools$label[6], '"]) .range(["grey", "black", "black", "#ffe070", "red", "blue", "green", "orange", "purple", "pink"])', sep="")
