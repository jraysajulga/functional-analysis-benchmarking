...
my_color <- paste('d3.scaleOrdinal() .domain(["invisible", "block", "', tool1_label, '", "', tool2_label, '", "', tool3_label, '", "', tool4_label, '", "', tool5_label, '"]) .range(["white", "black", "red", "blue", "green", "orange", "purple"])', sep="")
my_color
