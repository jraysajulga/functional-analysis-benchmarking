...
```
```{r}
read.delim('results/rank_tables/normal/MF/unipept-rank_table.tabular')
```
```{r}
read.delim('results/rank_tables/expanded/MF/unipept-rank_table.tabular')
```

```{r}
read.delim('results/rank_tables/filtered/MF/unipept-rank_table.tabular')
```
