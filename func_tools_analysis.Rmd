...
ontology <- 'MF'
get_rank_table("Unipept", tools, 'full', ontology)
...
```
```{r}
read.delim('results/rank_tables/full/unipept-rank_table.tabular')
```
```{r}
megan_filtered
...
```{r}
read.delim('results/rank_tables/filtered/unipept-rank_table.tabular')
```
